...
class Lab01Activity : AppCompatActivity() {
            ...
            val button = Button(this).also {
                ...
                it.setOnClickListener {
                    val isPassed = when (i) {
                        ...
                        3 -> task13(0.0, 5.4f) && !task13(7.0, 5.4f) && !task13(
                            -6.0,
                            -1.0f
                        ) && task13(6.0, 9.1f) && !task13(6.0, -1.0f) && task13(1.0, 1.1f)

                        4 -> task14(-2, 5) == "-2 + 5 = 3" && task14(-2, -5) == "-2 - 5 = -7"
                        5 -> task15("DOBRY") == 4 && task15("barDzo dobry") == 5 && task15("doStateczny") == 3 && task15(
                            "Dopuszczający"
                        ) == 2 && task15("NIEDOSTATECZNY") == 1 && task15("XYZ") == -1

                        6 -> task16(
                            mapOf("A" to 2U, "B" to 4U, "C" to 3U), mapOf("A" to 1U, "B" to 2U)
                        ) == 2U && task16(
                            mapOf("A" to 2U, "B" to 4U, "C" to 3U), mapOf("F" to 1U, "G" to 2U)
                        ) == 0U && task16(
    ...
    fun task16(store: Map<String, UInt>, asset: Map<String, UInt>): UInt {
        ...
        return asset.map { (item, requiredAmount) ->
            if (requiredAmount > 0u) {
